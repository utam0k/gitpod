          ...
          cloudInitNoCloud:
            userData: |-
              ...
              runcmd:
                ...
                - sleep 10
                - kubectl label nodes ${vmName} gitpod.io/workload_meta=true gitpod.io/workload_ide=true gitpod.io/workload_workspace_services=true gitpod.io/workload_workspace_regular=true gitpod.io/workload_workspace_headless=true
